...
#define BLE_LOCAL_NAME                 "UserB BLE"

BLEService signalService("680d65c7-3a0a-4023-a05a-6aaf2f22441c");
BLECharacteristic signalChar("0007", BLERead | BLENotify | BLEBroadcast, BLE_BUFFER_SIZES);
...
void setup() {
  ...
  tflModel = tflite::GetModel(sine_model);
      ...
      while (samplesRead < numSamples) {
        ...
        if (IMU.accelerationAvailable() && IMU.gyroscopeAvailable()) {
          ...
          if (samplesRead == numSamples) {
            ...
            signalChar.writeValue(GESTURES[maxIndex],true);
            Serial.println();
          }
        }
      }
