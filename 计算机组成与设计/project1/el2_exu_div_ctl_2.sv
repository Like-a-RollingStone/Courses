...
`include "el2_param.vh"
  ...
  reg [31:0] divisor_dd;
  reg [31:0] dividend_d;
  wire [31:0] dividend_for_fp;
  wire [31:0] divisor_for_fp;
  ...
  fp_operation_latch op_latch(
        .clk(clk),          // 时钟
        .dp_valid(dp.valid),     // 数据有效信号
        .fp_add(fp.fp_add),       // 浮点加法操作
        .fp_mul(fp.fp_mul),       // 浮点乘法操作  
        .fp_div(fp.fp_div),       // 浮点除法操作
        .a(active_operation)
    );
  assign finish_dly_div_fp = ({32{active_operation[3]}} & {32{finish_dly}}) | ({32{active_operation[2]}} & {32{fpadd_done}});
  assign out[31:0] = {{32{active_operation[3]}}&{32{finish_dly}} & out_raw[31:0] }|{ {32{active_operation[2]}}&{32{fpadd_done}} & out_fpadd[31:0] } ; 
